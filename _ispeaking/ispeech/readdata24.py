...
class DataSpeech():
	...
	def GetSymbolList(self):
		...
		返回一个列表list类型变量
		"""
		#txt_obj=open('C:/Users/raymondzhao/myproject/dev.speech/asrt_speechrecognition/dict.txt','r',encoding='UTF-8')

		txt_obj = open('/data/raymond/workspace/speech/dict.txt','r',encoding='UTF-8')
