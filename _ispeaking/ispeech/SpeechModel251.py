...
if(__name__=='__main__'):
    ...
    datapath = "C:\\Users\\raymondzhao\\myproject\\dev.speech\\asrt_speechrecognition\\dataset\\"
    datapath = '/data/raymond/workspace/speech/dataset/'

    ms = ModelSpeech(datapath)
    
    ms.LoadModel(modelpath + '/m251/speech_model251_e_0_step_99900.model')
    #ms.TrainModel(datapath, epoch = 50, batch_size = 8, save_step = 100)
    #ms.SaveModel(modelpath + 'm251/speech_model251_e_50_step_500.model')
    ...
    #r = ms.RecognizeSpeech_FromFile('C:/Users/raymondzhao/myproject/dev.speech/asrt_speechrecognition/dataset/train/A2_0.wav')
    r = ms.RecognizeSpeech_FromFile('/data/raymond/workspace/speech/dataset/26-02.wav')
